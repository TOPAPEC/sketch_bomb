"""
BEiT + SDXL Pipeline Demo
Same setup as demo_pipeline_beit.py but uses SDXL + MistoLine ControlNet
instead of SD1.5 + lineart ControlNet.
...
def run_demo(n=10, seed=42):
    ...
    canvas_path = DEMO_OUT / "pipeline_beit_sdxl_demo.png"
